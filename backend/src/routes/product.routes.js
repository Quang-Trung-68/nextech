...
router.post('/', adminProtect, validate(createProductSchema), productController.createProduct);
router.put('/:id', adminProtect, validate(productParamsSchema, 'params'), validate(updateProductSchema), productController.updateProduct);
router.delete('/:id', adminProtect, validate(productParamsSchema, 'params'), productController.deleteProduct);
