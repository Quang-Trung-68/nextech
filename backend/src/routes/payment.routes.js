...
router.get(
  "/intent/:orderId",
  protect,
  paymentController.getOrderPaymentIntent,
);
...
// POST /api/payments/sepay/sync/:orderId — đồng bộ sau redirect SePay (bổ sung cho webhook IPN)
router.post(
  "/sepay/sync/:orderId",
  protect,
  paymentController.syncSepayOrder,
);
