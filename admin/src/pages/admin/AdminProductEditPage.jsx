  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Button type="button" variant="ghost" className="gap-2 -ml-2" onClick={() => navigate(adminPaths.products)}>
    ...
    <div className="space-y-6 max-w-[920px]">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <Button type="button" variant="ghost" className="gap-2 -ml-2 w-fit" onClick={() => navigate(adminPaths.products)}>
            <ArrowLeft className="h-4 w-4" />
            Quay lại danh sách
          </Button>
      ...
      <div className="rounded-lg border bg-card p-4 sm:p-6">
        <ProductEditor
          ...
          onCancel={() => navigate(adminPaths.products)}
          isLoading={isSaving}
