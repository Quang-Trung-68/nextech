...
import { adminPaths } from '@/configs/adminPaths';
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          icon={DollarSign}
        />
        <div onClick={() => navigate(adminPaths.orders)} className="cursor-pointer transition hover:scale-105">
          <StatCard
            title="Tổng đơn hàng"
        ...
        <div onClick={() => navigate(adminPaths.products)} className="cursor-pointer transition hover:scale-105">
          <StatCard
            title="Sản phẩm"
        ...
        <div onClick={() => navigate(adminPaths.users)} className="cursor-pointer transition hover:scale-105">
          <StatCard
            title="Người dùng"
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div onClick={() => navigate(adminPaths.inventorySerials)} className="cursor-pointer transition hover:scale-105">
          <StatCard
        ...
        <div
          onClick={() => navigate(adminPaths.inventorySerialsLow)}
